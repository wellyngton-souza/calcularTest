...
def abrir():
    ...
    label = customtkinter.CTkLabel(window, text="Multiplicar")
    ...
    button = customtkinter.CTkButton(window, width=137, height=25, text="Calcular", command=Multiplicar)
