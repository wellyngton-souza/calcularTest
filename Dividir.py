...
def abrir():
    ...
    label = customtkinter.CTkLabel(window, text="Dividir")
    ...
    button = customtkinter.CTkButton(window, width=137, height=25, text="Calcular", command=Dividir)
